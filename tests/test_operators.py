...
def test_symmetric(a: float, b: float) -> None:
    """
    Ensures that :func:`minitorch.operators.mul` is symmetric, i.e.
...
def test_distribute(a: float, b: float, c: float) -> None:
    """
    Ensures that your operators distribute, i.e.
...
@pytest.mark.task0_2
@given(small_floats, small_floats, small_floats)
def test_associative(a: float, b: float, c: float) -> None:
    """
    Ensures some other property holds for your functions.
    """
...
def test_sum_distribute(ls1: List[float], ls2: List[float]) -> None:
    """
    Ensures that the sum of `ls1` plus the sum of `ls2`
